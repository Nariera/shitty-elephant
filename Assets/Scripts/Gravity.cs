...
public class Gravity : MonoBehaviour
{
    ...
    private void UpdateWinCondition()
    {
        ...
        if (Achievement.instance.IsTriggered("Facey McFace approached.")) totalVisits++;
        if (Achievement.instance.IsTriggered("Blue Giant approached.")) totalVisits++;
        if (Achievement.instance.IsTriggered("Mudders Anonymopus approached.")) totalVisits++;
        if (Achievement.instance.IsTriggered("Dinosaur Egg approached.")) totalVisits++;
        if (Achievement.instance.IsTriggered("Cratered My Yoshi approached.")) totalVisits++;
        if (Achievement.instance.IsTriggered("Cam's Vacation approached.")) totalVisits++;
        if (Achievement.instance.IsTriggered("Jackie approached.")) totalVisits++;
        if (Achievement.instance.IsTriggered("The Shining approached.")) totalVisits++;
